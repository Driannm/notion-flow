...
import {
  getDebtById,
  updateDebtOrLoan,
} from "@/app/action/finance/debtsAction"; // Cek typo path
...
export default function EditDebtPageV2({ params }: { params: { id: string } }) {
  const { id } = params;
  ...
  const percentage =
    numTotal > 0 ? Math.min((numPaid / numTotal) * 100, 100) : 0;
    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900 font-sans pb-24 selection:bg-orange-100">
      ...
      <div className="px-6 max-w-md mx-auto">
        ...
        <div className="flex flex-col items-center mb-8">
          <label className="text-xs font-bold text-zinc-400 uppercase tracking-widest mb-2">
            Total Amount
          </label>
